 ...
 */
enum {
    LV_PART_MAIN         = 0x000000,   /**< 对象的主区域 A background like rectangle*/
    LV_PART_SCROLLBAR    = 0x010000,   /**< 滚动条 The scrollbar(s)*/
    LV_PART_INDICATOR    = 0x020000,   /**< 滑动条 Indicator, e.g. for slider, bar, switch, or the tick box of the checkbox*/
    LV_PART_KNOB         = 0x030000,   /**< 可拖拽的按钮 Like handle to grab to adjust the value*/
    LV_PART_SELECTED     = 0x040000,   /**< 选中项 Indicate the currently selected option or section*/
    LV_PART_ITEMS        = 0x050000,   /**< 多元素项 Used if the widget has multiple similar elements (e.g. table cells)*/
    LV_PART_TICKS        = 0x060000,   /**< 刻度线 Ticks on scale e.g. for a chart or meter*/
    LV_PART_CURSOR       = 0x070000,   /**< 光标 Mark a specific place e.g. for text area's cursor or on a chart*/

    LV_PART_CUSTOM_FIRST = 0x080000,    /**< 自定义 Extension point for custom widgets*/

    LV_PART_ANY          = 0x0F0000,    /**< 任意部分 Special value can be used in some functions to target all parts*/
};
