...
enum {
    ...
    LV_LABEL_LONG_DOT,              /**< 省略号 Keep the size and write dots at the end if the text is too long*/
    LV_LABEL_LONG_SCROLL,           /**< 来回滚动 Keep the size and roll the text back and forth*/
    LV_LABEL_LONG_SCROLL_CIRCULAR,  /**< 循环滚动 Keep the size and roll the text circularly*/
    LV_LABEL_LONG_CLIP,             /**< 超过内容直接裁剪 Keep the size and clip the text out of it*/
};
