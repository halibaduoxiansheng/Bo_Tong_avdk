 ...
 *https://fonts.google.com/specimen/Montserrat*/
    ...
    #ifdef CONFIG_LV_FONT_MONTSERRAT_48 // 开启这个 如果需要使用
...
#ifndef MY_FONT 
    #ifdef CONFIG_MY_FONT // 开启这个 如果需要使用
        #define MY_FONT CONFIG_MY_FONT
    #else
        #define MY_FONT 0
    #endif
#endif

#ifndef SIMPLIFIED_COMMON_WORDS 
    #ifdef CONFIG_MY_FONT1 // 开启这个 如果需要使用
        #define SIMPLIFIED_COMMON_WORDS CONFIG_MY_FONT1
    #else
        #define SIMPLIFIED_COMMON_WORDS 0
    #endif
#endif
