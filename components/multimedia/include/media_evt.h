...
#include "aud_tras_drv.h" /* NOTE record 需要使用 */
...
typedef enum
{
	...
	/* NOTE 下面的所有都是 属于 AUD_EVENT 的 ，所以查找直接在 major mailbox 中 查找 AUD_EVENT */
	...
	/* ADD FOR I4S */
	EVENT_AUD_VOC_CLEAR_SPK_BUF_REQ,
	...
	EVENT_LVCAM_LVGL_UINT8_FONT,
	EVENT_LVCAM_LVGL_OTA,
	...
	EVENT_BT_A2DP_STATUS_NOTI_REQ,
	EVENT_BT_PCM_WRITE_REQ,
    ...
    EVENT_ASR_RECEIVE_ADDRESS,
#if I4S_RECORD_REPEAT_MODE
    EVENT_ASR_OPEN_RECORD_IND,
    EVENT_ASR_CLOSE_RECORD_IND,
#endif
