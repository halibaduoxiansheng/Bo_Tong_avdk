...
#define BK_ERR_AUD_INTF_START_CPU2        (BK_ERR_AUD_INTF_BASE - 16)         /**< aud_intf start cpu2 fail */
...
typedef struct {
	...
	int (*i4s_aud_intf_tx_mic_data)(unsigned char *data, unsigned int size);
...
/* prompt tone event */
typedef enum {
	AUD_INTF_VOC_ASR_WAKEUP = 0,
	AUD_INTF_VOC_ASR_STANDBY,
#if 1//I4S_RECORD_REPEAT_MODE
	AUD_INTF_VOC_ASR_OPEN_RECORD,
	AUD_INTF_VOC_ASR_CLOSE_RECORD,
#endif	
	AUD_INTF_VOC_NETWORK_PROVISION,
	AUD_INTF_VOC_NETWORK_PROVISION_SUCCESS,
	AUD_INTF_VOC_NETWORK_PROVISION_FAIL,
	AUD_INTF_VOC_RECONNECT_NETWORK,
	AUD_INTF_VOC_RECONNECT_NETWORK_SUCCESS,
	AUD_INTF_VOC_RECONNECT_NETWORK_FAIL,
	AUD_INTF_VOC_RTC_CONNECTION_LOST,
	AUD_INTF_VOC_AGENT_JOINED,
